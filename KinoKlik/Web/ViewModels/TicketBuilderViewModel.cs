...
{
    public List<KinoKlik.Model.Entities.Cinema> Cinemas { get; set; } = new();
}
...
public class TicketBuilderCheckoutInputModel
{
    ...
    [Display(Name = "Telefon (opcionalno)")]
