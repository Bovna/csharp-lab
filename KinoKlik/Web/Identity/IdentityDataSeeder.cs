...
namespace KinoKlik.Web.Identity;
...
public static class IdentityDataSeeder
{
        ...
        string role)
    {
        ...
        if (user is null)
        {
            await EnsureUser(
                ...
                oib: GetOptionalSeedValue(userSection, "OIB"),
                jmbag: GetOptionalSeedValue(userSection, "JMBAG"),
                role,
    ...
    private static string GetOptionalSeedValue(IConfigurationSection section, string key)
    {
        return section[key]?.Trim() ?? string.Empty;
    }
}
