...
public class TicketBuilderController : Controller
{
    ...
    public IActionResult Purchase([Bind(Prefix = "Input")] TicketBuilderCheckoutInputModel input)
    {
        ...
        {
            TicketNumber = GenerateTicketNumber(cinema!, confirmationCode),
    ...
    private static string GenerateTicketNumber(Cinema cinema, Guid confirmationCode)
    {
        ...
        return $"{code}-{DateTime.UtcNow.Year}-{confirmationCode:N}".ToUpperInvariant();
    }
